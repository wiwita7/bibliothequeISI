...
################################################################################
## Form generated from reading UI file 'dash_view.ui'
##
...
"")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icon/home.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon1.addFile(u":/icon/home-dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icon/books.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(u":/icon/books-dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icon/dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon3.addFile(u":/icon/authors-dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icon/clock.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon4.addFile(u":/icon/clock-dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icon/sub.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon5.addFile(u":/icon/sub-dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icon/exit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon6.addFile(u":/icon/exit-dark.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
